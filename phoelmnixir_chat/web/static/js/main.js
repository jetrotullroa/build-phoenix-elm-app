...
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {phxSocket: a, messageInProgress: b, messages: c};
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"SendMessage":[],"GetMessage":["String"],"ReceiveMessage":["Json.Encode.Value"],"HandleSendError":["Json.Encode.Value"],"PhoenixMsg":["Phoenix.Socket.Msg Messages.Msg"],"Something":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
