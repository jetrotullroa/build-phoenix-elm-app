...
require.register("web/elm/Commands.elm", function(exports, require, module) {

});

;require.register("web/elm/Contact/View.elm", function(exports, require, module) {

});

;require.register("web/elm/ContactList/View.elm", function(exports, require, module) {

});

;require.register("web/elm/Decoders.elm", function(exports, require, module) {
...
;require.register("web/elm/Messages.elm", function(exports, require, module) {
...
;require.register("web/elm/elm-stuff/packages/elm-community/json-extra/2.1.0/src/Json/Decode/Extra.elm", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-community/json-extra/2.1.0/src/Json/Encode/Extra.elm", function(exports, require, module) {
...
var elmDiv = document.querySelector('#elm_target');
...
(function () {
	...
	var _elm_community$json_extra$Json_Decode_Extra$fromResult = function _elm_community$json_extra$Json_Decode_Extra$fromResult(result) {
		var _p0 = result;
		if (_p0.ctor === 'Ok') {
	...
	var _elm_community$json_extra$Json_Decode_Extra$sequence = function _elm_community$json_extra$Json_Decode_Extra$sequence(decoders) {
	...
	var _elm_community$json_extra$Json_Decode_Extra$optionalField = F2(function (fieldName, decoder) {
		var finishDecoding = function finishDecoding(json) {
			var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, A2(_elm_lang$core$Json_Decode$field, fieldName, _elm_lang$core$Json_Decode$value), json);
			if (_p1.ctor === 'Ok') {
	...
	var _elm_community$json_extra$Json_Decode_Extra$withDefault = F2(function (fallback, decoder) {
		return A2(_elm_lang$core$Json_Decode$andThen, function (_p2) {
			return _elm_lang$core$Json_Decode$succeed(A2(_elm_lang$core$Maybe$withDefault, fallback, _p2));
	...
	var _elm_community$json_extra$Json_Decode_Extra$decodeDictFromTuples = F2(function (keyDecoder, tuples) {
		...
		if (_p3.ctor === '[]') {
			...
			if (_p4.ctor === 'Ok') {
				return A2(_elm_lang$core$Json_Decode$andThen, function (_p5) {
					return _elm_lang$core$Json_Decode$succeed(A3(_elm_lang$core$Dict$insert, _p4._0, _p3._0._1, _p5));
	...
	var _elm_community$json_extra$Json_Decode_Extra$dict2 = F2(function (keyDecoder, valueDecoder) {
		return A2(_elm_lang$core$Json_Decode$andThen, function (_p6) {
			return A2(_elm_community$json_extra$Json_Decode_Extra$decodeDictFromTuples, keyDecoder, _elm_lang$core$Dict$toList(_p6));
		}, _elm_lang$core$Json_Decode$dict(valueDecoder));
	});
	var _elm_community$json_extra$Json_Decode_Extra$set = function _elm_community$json_extra$Json_Decode_Extra$set(decoder) {
		return A2(_elm_lang$core$Json_Decode$andThen, function (_p7) {
			return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Set$fromList(_p7));
		}, _elm_lang$core$Json_Decode$list(decoder));
	};
	var _elm_community$json_extra$Json_Decode_Extra$date = A2(_elm_lang$core$Json_Decode$andThen, function (_p8) {
		return _elm_community$json_extra$Json_Decode_Extra$fromResult(_elm_lang$core$Date$fromString(_p8));
	...
	var _user$project$Model$ContactList = F4(function (a, b, c, d) {
		return { entries: a, page_number: b, total_entries: c, total_pages: d };
	});
	var _user$project$Model$Contact = function _user$project$Model$Contact(a) {
		return function (b) {
			return function (c) {
				return function (d) {
					return function (e) {
	...
	var _user$project$Decoders$contactDecoder = A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], _elm_lang$core$Json_Decode$succeed(_user$project$Model$Contact), A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int)), A2(_elm_lang$core$Json_Decode$field, 'first_name', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'last_name', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'gender', _elm_lang$core$Json_Decode$int)), A2(_elm_lang$core$Json_Decode$field, 'birth_date', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'phone_number', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'location', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'email', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'headline', _elm_lang$core$Json_Decode$string)), A2(_elm_lang$core$Json_Decode$field, 'picture', _elm_lang$core$Json_Decode$string));
	var _user$project$Decoders$contactListDecoder = A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], A2(_elm_community$json_extra$Json_Decode_Extra_ops['|:'], _elm_lang$core$Json_Decode$succeed(_user$project$Model$ContactList), A2(_elm_lang$core$Json_Decode$field, 'entries', _elm_lang$core$Json_Decode$list(_user$project$Decoders$contactDecoder))), A2(_elm_lang$core$Json_Decode$field, 'page_number', _elm_lang$core$Json_Decode$int)), A2(_elm_lang$core$Json_Decode$field, 'total_entries', _elm_lang$core$Json_Decode$int)), A2(_elm_lang$core$Json_Decode$field, 'total_pages', _elm_lang$core$Json_Decode$int));
	var _user$project$Decoders$ContactResponse = F2(function (a, b) {
		return { contact: a, error: b };
	});

	var _user$project$Messages$FetchResult = function _user$project$Messages$FetchResult(a) {
	...
	var _user$project$Contact_View$contactView = function _user$project$Contact_View$contactView(model) {
		var fullName = A2(_elm_lang$core$Basics_ops['++'], model.first_name, A2(_elm_lang$core$Basics_ops['++'], ' ', model.last_name));
				...
				_0: A2(_elm_lang$html$Html$header, { ctor: '[]' }, {
					...
					_1: {
						...
						_0: A2(_elm_lang$html$Html$div, {
							...
							ctor: '::',
							_0: A2(_elm_lang$html$Html$h4, { ctor: '[]' }, {
								ctor: '::',
	...
	var _user$project$ContactList_View$contactList = function _user$project$ContactList_View$contactList(model) {
	...
	var _user$project$ContactList_View$indexView = function _user$project$ContactList_View$indexView(model) {
		return A2(_elm_lang$html$Html$div, {
			ctor: '::',
	...
	var _user$project$Update$update = F2(function (msg, model) {
		var _p0 = msg;
		if (_p0._0.ctor === 'Ok') {
			return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { contactList: _p0._0._0 }), { ctor: '[]' });
		} else {
			return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
	...
	var _user$project$View$headerView = A2(_elm_lang$html$Html$header, {
		ctor: '::',
		...
		_0: A2(_elm_lang$html$Html$h1, { ctor: '[]' }, {
			ctor: '::',
			_0: _elm_lang$html$Html$text('Elmnix : Trying both Phoenix and Elm'),
			_1: { ctor: '[]' }
		}),
		_1: { ctor: '[]' }
	});
	var _user$project$View$view = function _user$project$View$view(model) {
		return A2(_elm_lang$html$Html$section, { ctor: '[]' }, {
			ctor: '::',
	...
	var _user$project$Main$init = A2(_elm_lang$core$Platform_Cmd_ops['!'], _user$project$Model$initialModel, {
		ctor: '::',
